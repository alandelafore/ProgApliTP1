...
while idParticipante > 0:
    ...
    disp = Disparo(idParticipante, nombreParticipante, apellidoParticipante, edadParticipante, sexoParticipante, x1, y1, x2, y2, x3, y3)
    concurso.agregarParticipante(disp)
    idParticipante=int(input('Ingrese el número de participante (Ingrese 0 para finalizar):'))
